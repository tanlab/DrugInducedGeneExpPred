...
for cell_line in ['VCAP', 'A549', 'A375', 'PC3', 'MCF7', 'HT29']:
    for descriptor in ['ecfp']:
        for target in ['up', 'dn']:
            ...
            mlflow.log_param('Model Type', 'Single-Task-LR')
            if target == 'up':
            ...
            mlflow.log_param('tol', '0.0001')
            mlflow.log_param('C', '1.0')
            mlflow.log_param('solver', 'lbfgs')
            mlflow.log_param('max_iter', '100')
            mlflow.log_param('lr_random_state', '0')
            ...
            for idx in range(len(indexes)):
                ...
                for i, (trn, val) in enumerate(folds):
                    ...
                    model = LogisticRegression(penalty='l2', tol=0.0001, C=1.0, class_weight=weights,
